...
CREATE TABLE IF NOT EXISTS dashboard_users (
  ...
  companies text[] default '{"All"}'::text[],
...
INSERT INTO app_config (config_type, data) VALUES
    ('PRODUCTIVE_APPS', '["code", "pycharm", "excel", "word", "vscode", "sublime", "notepad++", "cursor", "electron", "postman", "outlook", "Antigravity", "teams"]'),
    ('PRODUCTIVE_URLS', '["github.com", "stackoverflow.com", "kaggle.com", "notion.so", "chatgpt.com", "sharepoint.com", "localhost:5000", "localhost:5173", "localhost:3000"]'),
    ('WASTED_APPS', '["youtube", "facebook", "instagram", "twitter", "tiktok", "reddit", "netflix", "WhatsApp", "Solitaire & Casual Games"]'),
    ('WASTED_URLS', '["youtube.com", "facebook.com", "instagram.com", "tiktok.com", "reddit.com", "netflix.com", "web.whatsapp.com"]'),
    ('NEUTRAL_APPS', '["explorer", "finder", "settings", "terminal", "cmd", "spotify"]'),
    ('NEUTRAL_URLS', '["google.com", "bing.com", "yahoo.com", "spotify.com"]'),
